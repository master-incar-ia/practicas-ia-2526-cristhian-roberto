...
from .model import DoubleMultiLayerPerceptron
...
def evaluate_and_plot(loader, model, dataset_name, output_folder):
    ...
    df["y_true"] = df["y_true"] * 100.0
    df["y_pred"] = df["y_pred"] * 100.0

    
    all_targets = all_targets * 100.0
    all_outputs = all_outputs * 100.0
...
if __name__ == "__main__":
    ...
    model = DoubleMultiLayerPerceptron(input_dim=1, output_dim=1,num_hidden_neurons=64, apodo="MLP_seno")
